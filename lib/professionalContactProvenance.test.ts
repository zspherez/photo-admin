...
test("comprehensive public-provider and generic named-person policies reject variants", () => {
  ...
  for (const email of [
    ...
    "nyc.press@ledpresents.com",
    "us-support@ledpresents.com",
    "la.media@ledpresents.com",
    "eu.finance@ledpresents.com",
    "nycpress@ledpresents.com",
    "ussupport@ledpresents.com",
    "eupublicrelations@ledpresents.com",
    "eu.public-relations@ledpresents.com",
...
test("authoritative primary entity rejects extra distinctive organization tokens", () => {
  const candidate = {
    ...directCandidate,
    email: "jane.doe@agency.com",
    sourceUrls: [
        ...
        { outcome: "candidates", candidates: [candidate] },
        {
          ...
          fetchedSources: [
            ...
            },
            {
              ...
              observedEmails: [],
              observedDomains: ["agency.com"],
              primaryEntityTokens: ["agency", "led", "presents"],
              emailAssociations: [],
              ownershipStatements: [
                {
                  domain: "agency.com",
